...
# A fake index manager to simulate the behavior of MediaIndexManager.
class FakeIndexManager:
    ...
    def add_media_file_by_signature(self, media_file: DummyMediaFile) -> None:
...
class TestMediaDuplicateManager(unittest.TestCase):
    ...
    def test_get_possibly_duplicates(self):
        ...
        result = MediaDuplicateManager.get_possibly_duplicates(self.fake_index)
    ...
    def test_duplicates_map(self):
        ...
        dup_map = MediaDuplicateManager.duplicates_map(self.fake_index)
    ...
    def test_propagate_signature(self):
        ...
        MediaDuplicateManager.propagate_signature(self.fake_index)
    ...
    def test_propagate_camera_model(self):
        ...
        MediaDuplicateManager.propagate_camera_model(self.fake_index)
