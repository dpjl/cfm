...
class BatchResetInternalMd(CFMBatch):
    ...
    def __init__(self, media_set_dir):
        self.media_set: MediaSet = MediaSet.load_media_set(media_set_dir)
    ...
    @staticmethod
    def reset(internal_metadata: Metadata):
    ...
    def post_task(self, result_internal_metadata: Metadata, progress_bar, replace=False):
